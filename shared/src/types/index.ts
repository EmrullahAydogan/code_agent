...
export interface Workflow {
  ...
  currentStep?: number; // Alias for currentStepIndex
  result?: any;
  error?: string;
  createdAt: Date;
  startedAt?: Date;
...
export interface TestCase {
  ...
  error?: string;
  duration?: number;
  executionTime?: number; // Alias for duration
  createdAt: Date;
  runAt?: Date;
}
...
export interface TestSuite {
  ...
  passedTests: number;
  failedTests: number;
  filePath?: string; // Source file path for tests
  autoGenerated?: boolean; // Whether tests were AI-generated
...
export interface KnowledgeBase {
  ...
  projectId?: string;
  documents: number;
  documentCount?: number; // Alias for documents
  chunks: number;
  chunkCount?: number; // Alias for chunks
  indexed: boolean;
  status?: 'indexing' | 'ready' | 'failed';
  indexedAt?: Date;
  lastIndexed?: Date; // Alias for indexedAt
  createdAt: Date;
  updatedAt: Date;
}
...
export interface SearchResult {
  ...
  score: number;
  distance?: number;
  // Convenience properties (aliases from chunk)
  file?: string;
  content?: string;
  metadata?: any;
}
